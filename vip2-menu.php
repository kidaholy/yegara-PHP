...
<div class="p-10 space-y-10">
    <div class="flex items-center justify-between">
        <div class="space-y-1">
            <h1 class="text-3xl font-black font-playfair italic text-white tracking-tight gold-glow">VIP 2 Presidential Menu</h1>
            <p class="text-[10px] font-black uppercase tracking-[0.3em] text-[#d4af37]/40">Supreme Culinary Curation</p>
        </div>
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="category" id="menu-category" class="w-full bg-black/40 border border-white/5 rounded-2xl py-4 px-6 text-sm outline-none appearance-none">
                            <option value="VIP 2 Special">VIP 2 Special</option>
                        </select>
                    </div>
                </div>
                <textarea name="description" id="menu-desc" placeholder="Supreme description..." rows="3" class="w-full bg-black/40 border border-white/5 rounded-2xl py-4 px-6 text-sm outline-none"></textarea>
            </div>
            <div class="space-y-6">
...
<script>
    window.AdminServices = {
        ...
        saveMenuItem: async (e) => {
            ...
            const url = id 
                ? `api/admin/menu.php?id=${id}&collection=vip2Menu` 
                : `api/admin/menu.php?collection=vip2Menu`;
            
            data.collection = 'vip2Menu';
